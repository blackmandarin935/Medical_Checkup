...
const diseases = [
  ...
  },
  {
    ...
    name: '부정맥',
    region: 'heart',
    symptoms: ['심장 두근거림', '불규칙한 맥박', '어지럼', '흉부 불편', '피로'],
    treatments: ['심전도 평가', '약물 치료', '생활습관 개선'],
    prevention: ['카페인 조절', '수면 개선', '스트레스 관리'],
    progression: ['리듬 이상 시작', '증상 반복', '합병증 위험'],
  },
  {
    id: 'pleurisy',
    name: '흉막염',
    region: 'chest',
    symptoms: ['찌르는 흉통', '깊은 숨 시 통증', '기침', '호흡 불편', '발열'],
    treatments: ['통증 조절', '원인 치료', '휴식'],
    prevention: ['감염 예방', '기저 질환 관리', '금연'],
    progression: ['흉막 자극', '통증 증가', '호흡 제한'],
  },
  {
    id: 'copd',
    name: '만성폐쇄성폐질환',
    region: 'lung',
    symptoms: ['만성 기침', '가래', '호흡 곤란', '운동 시 숨참', '피로'],
    treatments: ['흡입 치료', '호흡 재활', '금연'],
    prevention: ['금연', '미세먼지 회피', '예방 접종'],
    progression: ['폐기능 저하', '활동 제한', '증상 악화'],
  },
  {
    id: 'meningitis',
    name: '수막염',
    region: 'brain',
    symptoms: ['심한 두통', '목 경직', '발열', '구역감', '의식 저하'],
    treatments: ['응급 진료', '항생제', '수액'],
    prevention: ['예방 접종', '감염 예방', '손 씻기'],
    progression: ['염증 진행', '신경 증상 증가', '응급 위험'],
  },
  {
    id: 'allergic_dermatitis',
    name: '알레르기 피부염',
    region: 'skin',
    symptoms: ['발진', '가려움', '부종', '홍반', '따가움'],
    treatments: ['항히스타민', '보습', '원인 회피'],
    prevention: ['알레르겐 회피', '보호 장갑', '보습 유지'],
    progression: ['염증 반복', '피부 자극', '재발 가능'],
  },
  {
    id: 'laryngitis',
    name: '후두염',
    region: 'throat',
    symptoms: ['목 쉼', '인후통', '기침', '목 따가움', '발열'],
    treatments: ['휴식', '수분 섭취', '필요 시 약물'],
    prevention: ['과도한 발성 피하기', '감기 예방', '실내 습도 유지'],
    progression: ['염증 진행', '음성 변화', '기침 지속'],
  },
  {
    id: 'tinnitus',
    name: '이명',
    region: 'ear',
    symptoms: ['귀 울림', '청력 저하', '집중 저하', '수면 장애', '불안'],
    treatments: ['청력 검사', '소리 치료', '스트레스 관리'],
    prevention: ['소음 노출 감소', '이어폰 시간 제한', '휴식'],
    progression: ['소리 인지 증가', '피로 누적', '생활 불편'],
  },
  {
    id: 'dry_mouth',
    name: '구강건조',
    region: 'throat',
    symptoms: ['입 마름', '삼킴 불편', '구취', '혀 화끈거림', '갈증'],
    treatments: ['수분 보충', '구강 보습제', '약물 조정'],
    prevention: ['수분 섭취', '카페인 줄이기', '구강 위생'],
    progression: ['점막 건조', '불편 지속', '구강 감염 위험'],
  },
  {
    id: 'kidney_infection',
    name: '신우신염',
    region: 'kidney',
    symptoms: ['옆구리 통증', '발열', '오한', '배뇨통', '피로'],
    treatments: ['항생제', '수분 섭취', '휴식'],
    prevention: ['요로 감염 예방', '수분 섭취', '위생 관리'],
    progression: ['감염 확산', '통증 증가', '전신 증상'],
  },
  {
    id: 'gastroenteritis',
    name: '급성 장염',
    region: 'intestine',
    symptoms: ['설사', '복통', '구토', '발열', '탈수'],
    treatments: ['수액', '전해질 보충', '휴식'],
    prevention: ['위생 관리', '조리 식품 주의', '손 씻기'],
    progression: ['장 염증', '탈수 위험', '회복 단계'],
  },
  {
    id: 'flu',
    name: '독감',
